...
class _HomePageState extends ConsumerState<HomePage> {
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    color: currentTab == 0
                        ? AppColors.calendarSecondaryColor
                        : Colors.transparent,
                    child: Center(
                      child: Text(
                        'HÁBITOS',
          ...
          Padding(
            ...
            child: Align(
              ...
              child: InkWell(
                ...
                onTap: () {
                  ref.read(selectedDateProvider.notifier).state = ref
                      .read(clockProvider)
                      .now();
                },
                child: Container(
                ...
                children: [
                  ...
                  if (index != displayHabits.length - 1)
                    Padding(
                      ...
                      child: const Divider(thickness: 0.3, height: 2),
                    ),
                ],
              );
            },
  ...
  DateTime _getClosestValidDateForHabit(
    HabitModel habit,
