...
void main() {
  ...
  group('TESTES DO WIDGET DAILOG DE CONCLUIR, EDITAR OU EXCLUIR UM HÁBITO.', () {
    testWidgets('Mantém o dialog aberto e bloqueia ações enquanto a exclusão ocorre.', (
        tester,
      ) async {
    ...
    testWidgets('Mantém a confirmação aberta e mostra mensagem de erro caso ocorra.', (
        tester,
      ) async {
        var calls = 0;
